...
parser.add_argument('--learning_rate', type=float, default=0.025, help='init learning rate')#0.10
...
parser.add_argument('--save', type=str, default='./results/CIFAR10_train/', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='PRDARTS', help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
parser.add_argument('--data_dir', type=str, default='/export/home/dataset/cifar10/', help='temp data dir')
...
def main():
    ...
    for epoch in range(start_epch, args.epochs):
        ...
        if valid_acc > best_acc:
            ...
            torch.save(state, os.path.join(args.save, 'best_weight_optimizers.pt'))
