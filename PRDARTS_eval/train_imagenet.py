...
parser.add_argument('--save', type=str, default='./results/ImageNet_train/', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='PRDARTS', help='which architecture to use')
...
parser.add_argument('--data_dir', type=str, default='/export/share/datasets/vision/', help='temp data dir')
parser.add_argument('--note', type=str, default='try', help='note for this run')

## Train ImageNet
#CUDA_VISIBLE_DEVICES=2,3 OMP_NUM_THREADS=16 python ./train_imagenet.py
...
#    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.decay_period, gamma=args.gamma)
    ...
    for epoch in range(args.epochs):
        ...
        print('Epoch time: %d h.' % (epoch_duration * (args.epochs - epoch) / 3600))
        ...
        if valid_acc_top5 > best_acc_top5:
            ...
            torch.save(state, os.path.join(args.save, 'top5_best_weight_optimizers.pt'))
        if valid_acc_top1 > best_acc_top1:
            best_acc_top1 = valid_acc_top1
            best_acc_top55 = valid_acc_top5
            is_best = True
            state = {
                'epoch': epoch + 1,
                'state_dict': model.state_dict(),
            ...
            torch.save(state, os.path.join(args.save, 'top1_best_weight_optimizers.pt'))
        ...
        print('best acc: top 1 %.4f  top 5 %.4f'%(best_acc_top1, best_acc_top55))
